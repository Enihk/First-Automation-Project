...
sudo unzip dashboard-service_linux_arm64.zip
sudo rm -rf dashboard-service_linux_arm64.zip
sudo mv dashboard-service_linux_arm64 dashboard
sudo mv dashboard /usr/bin
sudo chmod 755 /usr/bin/dashboard
sudo chown vagrant:vagrant /usr/bin/dashboard 
